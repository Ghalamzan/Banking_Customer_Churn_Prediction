# from Data_Preprocessing import churn_data_filtered_encoded
...
churn_dataa=pd.read_csv('Sample_data_500.csv')
pd.set_option('display.max_columns',None)
print(churn_dataa.head())
churn_data = churn_dataa.drop(columns=['row number in table','CustomerId','Surname'])
...
silhouet_average = silhouette_score(churn_data_filtered_encoded,churn_data_filtered_encoded['Cluster'])
